...
function DailyCardPage() {
    const [activeTab, setActiveTab] = useState('benefits');
    const card = cardDetailsData.daily;
        ...
        <div className={styles.pageContainer}>
            <section className={styles.cardSection}>
                ...
                <div className={styles.cardInfo}>
                    <h1 className={styles.cardTitle} style={{ color: card.theme.primary }}>{card.name}</h1>
                    <p className={styles.cardDesc}>{card.description}</p>

                    <Link to="/apply" className={styles.applyButton} style={{ backgroundColor: card.theme.primary }}>
                        지금 바로 신청하기
                    </Link>
                </div>
            </section>
            ...
            <section className={styles.contentSection}>
                ...
                <div className={styles.tabContent}>
                    {activeTab === 'benefits' && <BenefitDetails benefits={card.benefits} theme={card.theme} />}
